...
jQuery(document).ready(function($) {
	...
	------------------------------------------------ */
	$('.bs_selectmenu li a').click(function(event){
		
		var listvalue = $(this).data('state');
		var mainbox = $(this).data('parent');
		var selectmenu = $('.'+mainbox).data('select');
				
		$('.'+mainbox).find('.selectheadline').html($(this).data('text'));
		$('#'+selectmenu).val($(this).data('state'));
