  ...
  <div class="option option-background-upload" id="<?php echo $value->item_id; ?>_div">
    ...
    <div class="section">
      <div class="element">
		...
		if ($handle = opendir($absolute_path_to_theme.'/../nevada/images/footer/pattern/')) {
			...
			while (false !== ($file = readdir($handle))) {
				if($file != '..' && $file != '.') {
					...
					echo '<div class="single_pattern">
							...
							<label class="label-for-check" for="'.$value->item_id.'_'.$count.'"><div class="pattern" style="background: url('.get_template_directory_uri().'/../nevada/images/footer/pattern/'.$file.');"></div></label></div>';
					$count++;
				}
			}
