...
function recognized_font_transforms() {
  return apply_filters( 'recognized_font_transforms', array(
    'uppercase'  => 'uppercase',
...
/**
 * Recognized hover effects
 *
 * Returns an array of all recognized hover effects.
 *
 * @uses      apply_filters()
 *
 * @access    public
 ...
 * @return    array
 */
function recognized_hover_effects() {
  return apply_filters( 'recognized_hover_effects', array(
		"normal" 		=> "normal",
		"overlay" 		=> "overlay",
		"grayscale" 	=> "grayscale"
    ) );
...
/**
 * Recognized slice effects
 *
 * Returns an array of all recognized slice effects.
 *
 * @uses      apply_filters()
 *
 * @access    public
 ...
 * @return    array
 */
function recognized_slice_effects() {
  return apply_filters( 'recognized_slice_effects', array(
		"normal"				=> "normal",
 ...
 *
 * Returns an array of all recognized easing effects.
 *
 * @uses      apply_filters()
 *
 * @access    		public
 ...
 * @return    array
 */
function recognized_easing_effects() {
  return apply_filters( 'recognized_easing_effects', array(
    'linear'    		=> 'linear',
    'swing'     		=> 'swing',
...
/**
 * Recognized google fonts
 *
 * Returns an array of all recognized google fonts.
 *
 * @uses      apply_filters()
 *
 * @access    public
...
function recognized_google_fonts() {
	global $webfonts;
	return apply_filters( 'recognized_google_fonts', json_decode($webfonts) );
}
 ...
 *
 * Returns an array of all recognized color schemes.
 *
 * @uses      apply_filters()
 *
 * @access    public
 ...
 * @return    array
 */
function recognized_color_schemes() {
  return apply_filters( 'recognized_color_schemes', array(
    	'Custom'     	=> get_option_tree( 'themecolor'),
		'Green Apple' 	=> '#75a405',
		'Coffee' 	 	=> '#9A6742',
		'Blue'	 		=> '#1A88C1',
		'Purple' 		=> '#8F4EC2',
