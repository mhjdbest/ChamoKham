			...
			<div id="comment-<?php comment_ID(); ?>" class="single-comment clearfix">
                    ...
                    <article class="comment-body">
                    	...
                    	<header class="comment-header">
                            ...
                            <?php comment_reply_link(array_merge( $args, array('reply_text' => __('Reply',UT_THEME_NAME),'depth' => $depth, 'max_depth' => $args['max_depth']))); ?>
                        </header>
	...
	function customBackground() {
		...
		if($custom_wrap == 'boxed' && $backgroundtype != 'default_backgroundslider') {
			...
			if($backgroundtype == 'default_backgroundcolor') {
				 ...
				 echo 'body { background: url('.get_template_directory_uri().'/images/pattern/'.$backgroundpattern.') repeat; }';
				...
				echo 'html { background: url('.get_template_directory_uri().'/images/bg-textured/'.$backgroundtexture.') fixed; ';
...
if ( ! function_exists( 'customSliderBackground' ) ) {
	function customSliderBackground() {
		...
		if($backgroundtype == 'slider_default_backgroundpattern') {
			 ...
			 echo '#lambda-featured-header-wrap { background: url('.get_template_directory_uri().'/images/pattern/'.$backgroundpattern.') repeat; }';
			...
			echo '#lambda-featured-header-wrap { background: url('.get_template_directory_uri().'/images/bg-textured/'.$backgroundtexture.') top center; background-size: 100%; }';
...
if ( ! function_exists( 'customFooter' ) ) {
	function customFooter() {
		...
		//defaultvalues
		$backgroundtype = get_option_tree( 'footer_background_type');
		$backgroundcolor = get_option_tree( 'footer_default_backgroundcolor');
		$backgroundpattern = get_option_tree( 'footer_default_backgroundpattern');
		$backgroundtexture = get_option_tree( 'footer_default_backgroundtexture');
		$backgroundimage = get_option_tree( 'footer_default_backgroundimage');

		if($backgroundtype == 'footer_default_backgroundcolor') {
			
			 echo '#footer-wrap { background-color: '.$backgroundcolor.' !important; }';
			
		} elseif($backgroundtype == 'footer_default_backgroundpattern') {
			
			echo '#footer-wrap { background: url('.get_template_directory_uri().'/images/pattern/'.$backgroundpattern.'); }';
			
		} elseif($backgroundtype == 'footer_default_backgroundimage') {
				
			echo '#footer-wrap { background: url('.$backgroundimage.') fixed; '; ?>
			...
			} elseif($backgroundtype == 'footer_default_backgroundtexture') {
			
				echo '#footer-wrap { background: url('.get_template_directory_uri().'/images/bg-textured/'.$backgroundtexture.'); ';	?>
				background-position: center top;
...
if ( ! function_exists( 'GetLambdaLikePost' ) ) {
	function GetLambdaLikePost($arg = null) {
		...
		$title_text_like = __('Like', UT_THEME_NAME);
