...
if( !function_exists( 'render_service_column' ) ) {
    function render_service_column($metadata, $servicegrid='one_fourth', $last='', $home = false, $colnumber=1) { 			
				...
				if($home) { 
					...
					$metadata['col_icon']			= 	$metadata['col_'.$colnumber.'_icon'];
					$metadata['col_headline']		= 	$metadata['col_'.$colnumber.'_headline'];
					$metadata['col_content']		= 	$metadata['col_'.$colnumber.'_content'];
					$metadata['col_buttontext']		= 	$metadata['col_'.$colnumber.'_buttontext'];
					$metadata['col_link']			= 	$metadata['col_'.$colnumber.'_link'];
				...
				<?php } ?>	
					...
					<article class="service">
						...
						<?php if(isset($metadata['col_buttontext'])) { ?>
							...
							<a href="<?php echo $metadata['col_link']; ?>" class="excerpt" target="_self"><?php echo lambda_translate_meta($metadata['col_buttontext']); ?></a>
					...
					<ul class="clearfix">
						...
						if(is_array($testimonials)) {
							...
							<li style="margin-bottom:0px !important; margin-left:0px !important; padding:0 1px;">
								...
								<article class="testimonial-entry <?php echo $testimonialcolor; ?>">
