...
(function ($) {
	...
	$(document).ready(function () {
		...
		if(isCustomChecked) {
			$('#themecolor_div, #drop_down_background_color_div, #navigation_hover_div, #drop_down_font_color_hover_div, #drop_down_background_color_hover_div, #hover_color_rgb_div, #hover_opacity_div').hide();
		...
		$('.color-scheme-box').live('click', function() {
			...
			if($(this).data('scheme') == 'custom') {
				...
				$('#themecolor_div, #drop_down_background_color_div, #navigation_hover_div, #drop_down_font_color_hover_div, #drop_down_background_color_hover_div, #hover_color_rgb_div, #hover_opacity_div').show();				
...
(function ($) {
  Sidebar = {
    ...
    init: function () {
      ...
      $('.add-sidebar').live('click', function(event){
        event.preventDefault();
