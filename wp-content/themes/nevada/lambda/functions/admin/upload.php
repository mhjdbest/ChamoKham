  ...
  <div class="option option-upload" id="<?php echo $value->item_id; ?>_div">
    <div class="lambda-opttitle">
      ...
      <div class="element">
        ...
        <button id="upload_<?php echo $value->item_id; ?>" class="upload_button btn btn-success" rel="<?php echo $int; ?>" /><i class="icon-picture icon-white"></i> <?php _e('Upload', UT_THEME_NAME); ?></button>
