...
function lambda_slider_view() {
	...
	//internal counter
	$num=1;	
	$table_lambda_sliders = $wpdb->prefix . "lambda_sliders"; 	
	...
	<?php endif; ?>
       ...
       <tr>
		   ...
		   <td colspan="6">
				...
				<div class="controls">
				<input type="text" id="option_name" class="lambda_input" name="option_name" size="70" placeholder="<?php _e('Slider Name', UT_THEME_NAME); ?>" /><br />
				</div>
				...
				<select name="slidertype" class="lambdaselect">
					...
					<option value="supersized"><?php _e('superSized Slider', UT_THEME_NAME); ?></option>
	...
	if(!get_option($option)) {
   		...
   		if($option){
			...
			if($options || empty($slidertype))
            {
				...
				$sql = "INSERT INTO " . $table_lambda_sliders . " values ('','".$option."','".$slidertype."','1');";
                if ($wpdb->query( $sql )){
...
function lambda_slider_edit() { ?>
	...
	<div class="navbar">
			<div class="navbar-inner">
				...
				<ul class="options_tabs nav">
					<li><a href="#general-settings" data-toggle="tab"><?php _e('General Slider Settings', UT_THEME_NAME); ?></a></li>
					
					<?php //<li><a href="#image-settings" data-toggle="tab"><?php _e('Image Source Settings', UT_THEME_NAME); </a></li> ?>
					
					<li><a href="#image-items" data-toggle="tab"><?php _e('Add Slider Items', UT_THEME_NAME); ?></a></li>
				</ul>
	...
	<div id="image-items" class="tab-pane">
		...
		<button class="add_slider_item btn btn-success" title="<?php echo $_GET['slidertype']; ?>" name="<?php echo $slider; ?>"><i class="icon-picture icon-white"></i> <?php _e('Add Slide', UT_THEME_NAME); ?></button>
				...
				foreach ($slider_basic_items as $key => $value) { ?>
					...
					<div id="lambda_<?php echo $key; ?>" class="slider_item">
						...
						<div class="slider-content">
								...
								<input id="<?php echo $key; ?>" type="text" name="<?php echo $slider; ?>[slides][<?php echo $key; ?>][imgurl]" value="<?php echo $value['imgurl']; ?>" />
								...
								<textarea id="caption_<?php echo $key; ?>" name="<?php echo $slider; ?>[slides][<?php echo $key; ?>][video]"><?php echo $value['video']; ?></textarea>
								</div>
								...
								<input id="caption_<?php echo $key; ?>" type="text" name="<?php echo $slider; ?>[slides][<?php echo $key; ?>][caption_text]" value="<?php echo $value['caption_text']; ?>" /><br />
								...
								<input id="caption_link_<?php echo $key; ?>" type="text" name="<?php echo $slider; ?>[slides][<?php echo $key; ?>][caption_link]" value="<?php echo $value['caption_link']; ?>" /><br />
								...
								<input id="buttontext_<?php echo $key; ?>" type="text" name="<?php echo $slider; ?>[slides][<?php echo $key; ?>][buttontext]" value="<?php echo $value['buttontext']; ?>" /><br />
